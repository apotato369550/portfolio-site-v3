  ...
  return (
    ...
    >
      <div className="identity-gradient-container h-full w-full m-0 p-0">
        ...
        <img src={pillarImage.src} alt="pillar left" className="side-pillar side-pillar-left" />
        <img src={pillarImage.src} alt="pillar right" className="side-pillar side-pillar-right" />
