              ...
              <div className="tech-icons-container">
                <div className="tech-icon-container">
                  <img
                    ...
                    src="/assets/TechStackSection/html_5_photo.png"
                    alt="HTML5"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/css_photo.png"
                    alt="CSS3"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/js_photo.png"
                    alt="JavaScript"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/mongodb.png"
                    alt="MongoDB"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/express.js.png"
                    alt="Express.js"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/circle_react.png"
                    alt="React"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/node.js.png"
                    alt="Node.js"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/python.png"
                    alt="Python"
                  />
                </div>
              </div>
            ...
            <div className="tech-category-card tools-platforms">
              ...
              <div className="tech-icons-container">
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/github-logo.png"
                    alt="GitHub"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/firebase logo.png"
                    alt="Firebase"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/Jupyter_logo.svg.png"
                    alt="Jupyter"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/figma.png"
                    alt="Figma"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/git logo.png"
                    alt="Git"
                  />
                </div>
              </div>
            ...
            <div className="tech-category-card exploring">
              ...
              <div className="tech-icons-container">
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/c_logo.png"
                    alt="C Programming"
                  />
                </div>
                <div className="tech-icon-container">
                  <img
                    className="tech-stack-icon"
                    src="/assets/TechStackSection/scikitlearn logo.png"
                    alt="Scikit-learn"
                  />
                </div>
              </div>
